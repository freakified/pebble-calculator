...
#define CELL_RECT(row, col, colspan) \
  GRect((col) * CELL_W, BUTTON_AREA_Y + (row) * CELL_H, \
        (colspan) * CELL_W, CELL_H)
...
static CalcButton s_buttons[CALC_BUTTON_COUNT] = {
  ...
  {
    .bounds = { .origin = {0, 0}, .size = {0, 0} },
    .label = "7", .rpn_label = NULL,
    .action = CALC_ACTION_DIGIT_7, .rpn_action = CALC_ACTION_DIGIT_7,
    .style = BUTTON_STYLE_NUMBER,
  },
  {
    .bounds = { .origin = {0, 0}, .size = {0, 0} },
    .label = "8", .rpn_label = NULL,
    .action = CALC_ACTION_DIGIT_8, .rpn_action = CALC_ACTION_DIGIT_8,
    .style = BUTTON_STYLE_NUMBER,
  },
  {
    .bounds = { .origin = {0, 0}, .size = {0, 0} },
    .label = "9", .rpn_label = NULL,
    .action = CALC_ACTION_DIGIT_9, .rpn_action = CALC_ACTION_DIGIT_9,
    .style = BUTTON_STYLE_NUMBER,
  },
  {
    .bounds = { .origin = {0, 0}, .size = {0, 0} },
  ...
  {
    .bounds = { .origin = {0, 0}, .size = {0, 0} },
    .label = "4", .rpn_label = NULL,
    .action = CALC_ACTION_DIGIT_4, .rpn_action = CALC_ACTION_DIGIT_4,
    .style = BUTTON_STYLE_NUMBER,
  },
  {
    .bounds = { .origin = {0, 0}, .size = {0, 0} },
    .label = "5", .rpn_label = NULL,
    .action = CALC_ACTION_DIGIT_5, .rpn_action = CALC_ACTION_DIGIT_5,
    .style = BUTTON_STYLE_NUMBER,
  },
  {
    .bounds = { .origin = {0, 0}, .size = {0, 0} },
    .label = "6", .rpn_label = NULL,
    .action = CALC_ACTION_DIGIT_6, .rpn_action = CALC_ACTION_DIGIT_6,
    .style = BUTTON_STYLE_NUMBER,
  },
  {
    .bounds = { .origin = {0, 0}, .size = {0, 0} },
  ...
  {
    .bounds = { .origin = {0, 0}, .size = {0, 0} },
    .label = "1", .rpn_label = NULL,
    .action = CALC_ACTION_DIGIT_1, .rpn_action = CALC_ACTION_DIGIT_1,
    .style = BUTTON_STYLE_NUMBER,
  },
  {
    .bounds = { .origin = {0, 0}, .size = {0, 0} },
    .label = "2", .rpn_label = NULL,
    .action = CALC_ACTION_DIGIT_2, .rpn_action = CALC_ACTION_DIGIT_2,
    .style = BUTTON_STYLE_NUMBER,
  },
  {
    .bounds = { .origin = {0, 0}, .size = {0, 0} },
    .label = "3", .rpn_label = NULL,
    .action = CALC_ACTION_DIGIT_3, .rpn_action = CALC_ACTION_DIGIT_3,
    .style = BUTTON_STYLE_NUMBER,
  },
  {
    .bounds = { .origin = {0, 0}, .size = {0, 0} },
    .label = "+", .rpn_label = NULL,
    .action = CALC_ACTION_ADD, .rpn_action = CALC_ACTION_ADD,
    .style = BUTTON_STYLE_OPERATOR,
  },
  ...
  {
    .bounds = { .origin = {0, 0}, .size = {0, 0} },
    .label = "0", .rpn_label = NULL,
    .action = CALC_ACTION_DIGIT_0, .rpn_action = CALC_ACTION_DIGIT_0,
    .style = BUTTON_STYLE_NUMBER,
  },
  {
    .bounds = { .origin = {0, 0}, .size = {0, 0} },
    .label = ".", .rpn_label = NULL,
    .action = CALC_ACTION_DOT, .rpn_action = CALC_ACTION_DOT,
    .style = BUTTON_STYLE_NUMBER,
  },
  {
    .bounds = { .origin = {0, 0}, .size = {0, 0} },
